...
*/
var queryString = 'create table products (name varchar(255), description varchar(1024), price numeric, new boolean, sale boolean, stock integer, category varchar(128), imagePath varchar(255))';
